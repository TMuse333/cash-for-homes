...
//     link, reverse, aspectHeader
    ...
    export const experienceCard1 = {
      ...
      description:`Are you looking for a fast, reliable way to sell your house for cash in Ontario? At Ontario Cash For Houses, we specialize in buying homes quickly, offering a hassle-free and straightforward solution for homeowners in any situation. Whether your property needs repairs, you’re facing financial challenges, or simply want to sell without the delays and fees of a traditional real estate sale, we make it easy to sell your house as-is for a fair cash offer.

      Our proven process ensures you can sell your house fast, avoiding real estate agent commissions, closing costs, and the stress of listing on the market. From inherited properties to downsizing or relocating, we’ve helped countless homeowners achieve a fast and stress-free cash sale.
      
      Ready to see how it works? Visit our How It Works page to learn about our step-by-step process designed to help you sell your house for cash quickly and without complications. We make it simple to sell your house in Ontario—no matter the condition or circumstances. Contact us today to get a no-obligation cash offer and take the first step toward a hassle-free property sale.`,
      src:canadianDollar,

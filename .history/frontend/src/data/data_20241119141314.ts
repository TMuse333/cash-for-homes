...
//     link, reverse, aspectHeader
    ...
    export const experienceCard2 = {
      ...
      description: `At Ontario Cash For Houses, our process is designed to make selling your home fast and hassle-free. After receiving your fair cash offer, we handle everything from start to finish, including paperwork, closing details, and ensuring a smooth, stress-free experience.
    
      Whether you're looking to sell a house that needs repairs or want to avoid real estate agent fees and commissions, we make it simple. Learn more about our easy and efficient process by visiting our How It Works page. Let us guide you through a seamless, quick sale without the typical delays or complications of traditional real estate transactions.`,
      src: canadianDollar.src,

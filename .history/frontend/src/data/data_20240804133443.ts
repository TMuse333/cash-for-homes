...
export const content1Data:ContentType= {
  ...
  const processCarouselProps = {
    images: [
      {
        src:'/cash_for_home1.jpg',
        alt:'alt nation',
        description:'vLorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt ducimus quo rerum corrupti exercitationem et ut libero dicta, natus neque nisi, aperiam cupiditate inventore. Labore maxime'
      }
    ]

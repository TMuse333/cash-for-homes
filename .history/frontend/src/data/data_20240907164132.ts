...
export const content1Data:ContentType= {
 ...
 export const aboutContent1:Content2Type = {
    ...
    description:'Ontario Cash For Houses is a real estate solutions company that buys houses ins Windsor, ON; London, ON; Kitchener, ON; Waterloo, ON; Cambridge, ON; Whitby, ON; Oshawa, ON; Milton, ON; Georgetown, ON; North Bay, ON; Simcoe, ON; Goderich, ON; Orillia, ON; Muskoka, ON; and Haliburton, ON.',

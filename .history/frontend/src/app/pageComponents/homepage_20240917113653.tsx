...
<div className="mt-5
   ...
   hasAnimation={true}
   reverse={false}
   alt="A quality home in a ontario neighbourhood to signify that ontario cash for houses can take any property and sell it quick for cash"  //  background='bg-gradient-to-b from-blue-300 via-blue-500 to-blue-400 '
    />

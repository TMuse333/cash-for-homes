...
export const processFAQ = {
  ...
  description: "Selling your property can be a daunting process, but we aim to make it as simple and straightforward as possible. Below, you'll find answers to common questions about our process and how we can help you sell your house quickly and easily.",
  link: ''
};

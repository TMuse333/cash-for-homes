...
export default async function Post({ params }: PostProps) {
 ...
 <Head>
      ...
      <meta property="og:title" content={metaOpenGraph.title || title} />
      <meta property="og:description" content={metaOpenGraph.description || metaDescription} />
      <meta property="og:url" content={metaOpenGraph.url} />
      {postdametaOpenGraph.images.length > 0 && (
        <>

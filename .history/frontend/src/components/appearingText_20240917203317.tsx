...
const AppearingContent: React.FC<ContentProps> = ({
    ...
    const handleAnimation = async () => {
        ...
        await animate(`#border-top-${id}`, { width: "100%" }, { duration: 0.2 });
        await animate(`#border-left-${id}`, { height: "100%" }, { duration: 0.2 });
        await animate(`#border-bottom-${id}`, { width: "100%" }, { duration: 0.2 });
      
        await animate(`#border-right-${id}`, { height: "100%" }, { duration: 0.2 });
    ...
    }, [animationStarted,handleAnimation]);

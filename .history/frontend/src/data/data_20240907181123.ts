...
export const aboutCloser = {
  image:'/twenty-bills.jpeg',
    ...
    Whether facing foreclosure, repairs, probate, or other challenges, we aim to provide a hassle-free experience. No realtor fees, no closing costs, no repairs needed—we can close in as little as 24 hours. Call us today for a no-obligation cash offer: (64) 917-2806.`,
    destination:'/contact',
    buttonText:'Book a consulation',
} 

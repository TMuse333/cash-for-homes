...
export const content1Data:ContentType= {
  ...
  export const processParallax:ParallaxContentType = {
    src:process,
    isVideo:true,
    description:'Discover how easy it is to sell your property with our streamlined process. We’ve simplified every step to ensure a hassle-free experience, guiding you from the initial call to the final closing. Let’s explore the five key steps to make selling your house quick and straightforward!',
    muted:false,

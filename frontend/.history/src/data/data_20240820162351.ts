    ...
    images:[
      {
        ...
        title:'We Pay More',
        alt:'alt',
        description:'We buy so many houses that we save money on closing fees and the contractor fees. This allows us to offer you more.'
      },
      {
        src:canadianDollar,
        title:'Avoid Making Repairs',
        alt:'alt',
        description:'We pay cash which allows us to buy your house no matter what condition it is in. Don’t even think about fixing anything!'
      },
      {
        src:canadianDollar,
        title:'No Fees',
        alt:'alt',
        description:`We don’t charge any fees for our service. We simply just want to buy your house.`
      },
      {
        src:canadianDollar,
        title:'No Commissions',
        alt:'alt',
        description:'Avoid paying thousands of dollars to a real estate agent. They’re not needed. We are your buyer. You don’t need anyone to help you find a buyer.'
      },
      {
        src:canadianDollar,
        title:'Close Fast',
        alt:'alt',
        description:'Paying cash allows us to close super fast. If you want to close within a week, that’s usually possible. If you need some time, no problem!'
      },
      {
        src:canadianDollar,
        title:'We Pay Cash',
        alt:'alt',
        description:'Paying cash is important. This allows us to skip the hoops banks make buyers go through. This is how we keep things simple.'
      },
    ]
  }

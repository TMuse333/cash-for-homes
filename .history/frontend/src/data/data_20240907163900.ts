...
export const aboutContent3:ContentType = {
  image:multiHome,// Directly import the image as StaticImageData
    customText: null,
    description: [
      'We that focuses on helping homeowners like you find solutions for your problem property, whether you’re going through a foreclosure, divorce, inherited property, nuisance property, back taxes, can’t sell your property, or just need to sell your house for ANY reason. We can help!\n\n',

...
<h2 className="text-center text-black text-3xl sm:text-4xl font-semibold
mb-4">Testimonials here</h2>
<p className="text-center text-black mb-4 sm:text-lg">Our clients have had monumental success working with us, you can be next!</p>

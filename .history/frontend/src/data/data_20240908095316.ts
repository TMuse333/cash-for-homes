...
export const processFAQ = {
  text: [
      ...
      { 
          ...
          description: "Once you accept the offer, we will forward. You have the flexibility to choose the closing date that works best for you, making the process smooth and stress-free." 
      },
      { 

...
const Testimonials: React.FC<TestimonialProps> = ({ testimonials = testimonialsData }) => {
  ...
  const prevTestimonial = () => {
    ...
    return (
        ...
        <AnimatePresence  mode='wait'>
          <motion.p key={currentTestimonial} className="pl-8 pr-8 sm:text-xl"
           initial={{ opacity: 0, }}
        ...
        <AnimatePresence  mode='wait'>
          <motion.p key={currentTestimonial} className="mt-8 pl-6 md:pl-8 pr-8
          sm:text-lg"
        ...
        <AnimatePresence mode='wait'>
          <motion.p key={currentTestimonial} className="pl-8 pr-8 md:pl-8 sm:text-lg"
          initial={{ opacity: 0, y:30 }}

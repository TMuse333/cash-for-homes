...
const Process = () => {
    ...
    return (
            ...
            <main className="w-screen  bg-gray-200">
                ...
                <p className="text-center text-gray-800 text-xl sm:text-2xl md:text-3xl mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, deleniti quibusdam fugit dicta temporibus sed!</p>

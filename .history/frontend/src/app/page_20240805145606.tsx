...
<h2 className="text-center text-black text-2xl sm:text-4xl font-semibold">Testimonials here</h2>
<p className="text-center text-black">Our clients have had monumental success working with us, you can be next!</p>

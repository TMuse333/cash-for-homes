  ...
  export const processCarouselData = {
    images: [
      ...
      },
      {
        ...
        description: 'At closing, we’ll send all necessary documents to your lawyer. You’ll meet with your lawyer to finalize the sale, and the money will be directly given from your lawyer. It’s that simple—you get your cash quickly and securely.'
      }
    ],

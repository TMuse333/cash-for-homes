  ...
  const prevTestimonial = () => {
    ...
    return (
        <section className='bg-black border border-white ml-auto mr-auto max-w-[1200px] w-screen 
         ...
         h-[350px]
        '>
           <IoIosArrowForward className="absolute top-[40%] right-0 text-4xl" onClick={nextTestimonial} />
            <IoIosArrowBack className="absolute top-[40%] left-0 text-4xl" onClick={prevTestimonial} />

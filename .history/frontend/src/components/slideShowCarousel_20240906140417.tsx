...
// },[shift])
  ...
  return (
      ...
      '>
          ...
          md:scale-[1.5] '>
            {showRefreshBar ? (
               <FaRedo className="icon ml-auto mr-auto scale-[1.5] p-8" onClick={resetSlideShow} />
            ) : slideShowPaused ?  (
              <FaPlay className="icon ml-auto mr-auto scale-[1.5] p-8" onClick={togglePlay}/>
            ) : (
              <FaPause className="icon ml-auto mr-auto scale-[1.5] p-8" onClick={togglePlay} />
            )}
          </button>
      </div>
  );

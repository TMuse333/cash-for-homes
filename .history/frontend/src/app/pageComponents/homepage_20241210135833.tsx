...
const [slideComplete, setSlideComplete] = useState(false)
  ...
  return (
    ...
    links={links}
    />
  <main className="bg-gray-200 mt-[4rem]
  overflow-x-hidden
...
<p className={`mt-8 text-left mx-auto w-[90%] text-black mb-4 sm:text-lg pl-3 pr-3 transition-all
${slideComplete ? 'opacity-1' : 'opacity-0'}`}>
Discover our collection of insightful blogs packed with expert tips on how to sell your house for cash fast in Ontario, navigate the ever-changing real estate market, and make the best decisions for your future. Do not miss out—start exploring now!
</p>

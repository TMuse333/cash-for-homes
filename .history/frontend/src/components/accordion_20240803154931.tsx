  ...
  const componentRef = useIntersectionObserver(setInView, options);
    ...
    return (
        ...
        {hasIntro && (
          <>
            <div>
            <h1 className='text-2xl bg-gradient-to-b from-black to-gray-800 bg-clip-text text-transparent 
        ...
        ref={componentRef}>
            {text.map((text,index:number) => (
                ...
                w-screen ml-auto mr-auto md:w-[40vw] bg-blue-500
                hover:bg-blue-600 hover:rounded-lg max-w-[500px] text-white

...
export const processFAQ = {
  text: [
      ...
      { 
          ...
          description: "On the closing date you'll meet with your lawyer to finai, all necessary documents are sent to your lawyer. You’ll meet with your lawyer to finalize the sale, and the money will be directly transferred to you from your lawyer." 
      },
      { 

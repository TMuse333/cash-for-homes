            ...
            <AnimatePresence>
                ...
                >
                    <motion.p
                     ...
                     exit={{ opacity: 0, }}
                     transition={{ duration: 0.5 }} className='text-center mb-4 mt-2 text-3xl'>{currentTestimonial.title}</motion.p>
                    <motion.p className='ml-auto mr-auto mb-4'>{currentTestimonial.description}</motion.p>
                    <motion.p className='mb-4'>-{currentTestimonial.name}</motion.p>
                </motion.article>
            </AnimatePresence>
        </section>
    );

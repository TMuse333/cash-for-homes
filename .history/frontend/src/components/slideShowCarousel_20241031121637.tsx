  ...
  return (
      <section 
          ...
          className={`w-[95vw] pt-8  relative md:max-h-[800px]  h-[90vh]
             flex-shrink-0 overflow-y-hidden text-black
     `}
          style={{
...
<div className='flex mx-auto flex-col items-center justify-center bg-white bg-opacity-[0.2] rounded-2xl mr-4 ml-4
h-[90vh]  md:max-h-[800px] overflow-y-visible py-4'>


       <p className='mt-6 px-4 sm:text-lg md:text-xl px-8 '>{description}</p>
  ...
  <video
    ...
    loop
    muted
    className={`w-full mt-8 ml-auto mr-auto object-contain h-[70vh] overflow-y-visible
                md:max-h-[600px]
                rounded-2xl`}
  ...
  <Image
    src={src}
    alt={alt}
    className={`w-full mt-8 ml-auto mr-auto object-cover

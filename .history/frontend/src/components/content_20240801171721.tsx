             ...
             >
              {description != null ? description[1] :
                ...
                <motion.button
                  ...
                  initial={hasAnimation ? 'initial' : ''}
                  animate={hasAnimation && inView ? 'animate' : ''}
                 className="mt-6 bg-blue-500 p-3 rounded-xl hover:gray-200
                 hover:text-blue-500 hover:bg-gray-200  transition-all">{buttonText  ? buttonText : 'button'}</motion.button>
                  </Link>
            </motion.p>

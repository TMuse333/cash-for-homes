...
//  const {isMobile} = useGeneralContext()
  ...
  const componentRef = useIntersectionObserver(setInView, options);
    ...
    return (
        ...
        mb-5'>
Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum animi, itaque veniam cumque laboriosam omnis iure accusantium! Veniam ea vero dolor aliquid, ipsa nisi nesciunt esse repellendus laboriosam explicabo maxime.

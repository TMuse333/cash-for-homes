...
const Testimonials: React.FC<TestimonialProps> = ({ testimonials = testimonialsData }) => {
  ...
  const prevTestimonial = () => {
    ...
    return (
        ...
        h-[200px] p-10 relative'>
           <IoIosArrowForward className="absolute top-1/2 right-0 text-lg" onClick={nextTestimonial} />
            <IoIosArrowBack className="absolute top-1/2 left-0" onClick={prevTestimonial} />

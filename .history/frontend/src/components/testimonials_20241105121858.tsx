...
const testimonialsData = [
    {
        title: 'Millionaire',
        quote: `I was facing eviction and had only one day before I had to leave. I contacted [Company Name], and they stepped in to help right away. They not only bought my house the same day but also offered to rent it back to me while I looked for a new place. The speed, compassion, and flexibility they showed during such a stressful time were amazing. I’m incredibly grateful for how they turned a crisis into a smooth transition.`,
        author: 'B. Garcia',

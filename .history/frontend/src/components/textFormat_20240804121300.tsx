...
const TextFormat: React.FC<TextFormatProps> = ({ isAnimated, reverse  }) => {
  ...
  return (
    ...
    >
      Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt ducimus quo rerum corrupti exercitationem et ut libero dicta, natus neque nisi, aperiam cupiditate inventore. Labore maxime temporibus debitis autem molestiae? 
     
      {/* <div className={`${reverse ? 'md:-translate-x-0' : 'md:translate-x-6'}`}> */}
      <motion.h1 className="text-2xl pb-2 text-left ml-0 font-bold ">
      Title here</motion.h1>

    ...
    try {
        ...
        const mailOptions = {
            ...
            html: `
                ...
                <p><strong>City:</strong> ${projectDetails}</p>
                <p><strong>Province:</strong> ${projectDetails}</p>
                <p><strong>Reason for selling:</strong> ${projectDetails}</p>
                <p><strong>How soon do you need to sel:</strong> ${projectDetails}</p>
            `,
        };

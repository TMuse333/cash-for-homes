...
export const content1Data:ContentType= {
  ...
  export const content2Data:ContentType= {
    ...
    customText: null,
    description: [
      `Unlock the secrets to a hassle-free prop sale. Our proven process ensures that you get the best offer with minimal effort. Say goodbye to the traditional selling headaches and hello to a streamlined, straightforward experience.

  ...
  const prevTestimonial = () => {
    ...
    return (
        <section className='bg-black border border-white ml-auto mr-auto max-w-[1200px] w-screen 
         ...
         h-[350px]
        '>
           <IoIosArrowForward className="absolute top-[40%] right-0 text-2xl hover:text-blue-200" onClick={nextTestimonial} />
            <IoIosArrowBack className="absolute top-[40%] left-0 text-2xl" onClick={prevTestimonial} />
            
            <AnimatePresence  mode='wait'>
          <motion.p key={currentTestimonial} className="font-heavy mb-4 pl-6 pr-6 mt-8"
        ...
        <AnimatePresence  mode='wait'>
          <motion.p key={currentTestimonial} className="pl-6 pr-6"
           initial={{ opacity: 0, }}
        ...
        <AnimatePresence  mode='wait'>
          <motion.p key={currentTestimonial} className="mt-8 pl-6 pr-6"

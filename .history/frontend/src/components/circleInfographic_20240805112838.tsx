...
import builder from '../../media/gemeni-builder.jpg'
import twoHands from '../../media/gemeni-two-hand-stick.jpg'
import coder from '../../media/quantum-coder.jpg'
import thinker from '../../media/quantum-thinker.jpg'
import sprinter from '../../media/gemeni-sprinter.jpg'
import communicator from '../../media/gemeni-communicator.jpg'

...
const ImageHero: React.FC<HeroProps> = ({ images }) => {
    ...
    return (
        ...
        bg-gradient-to-tr from-blue-800 via-red-400 to-red-300 ">
...
<h1 className="relative text-4xl mb-4 mt-4 sm:text-6xl bg-gradient-to-b from-gray-800 to-gray-500 bg-clip-text text-transparent 
">

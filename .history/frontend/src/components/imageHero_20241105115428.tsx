...
<h1 className="relative text-4xl mb-4 mt-4 text-sm bg-gradient-to-b from-black to-gray-800 bg-clip-text text-transparent 
">
  Sell house fast ontario canada
</h1>

            <h2 className="mt-4  pr-4 pl-4 mb-5 text-black">Ontario Cash for Houses</h2>

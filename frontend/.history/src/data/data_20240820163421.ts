...
export const content1Data:ContentType= {
  ...
  export const content2Data:ContentType= {
    ...
    description: [
      ...
      `,
      `eady to take control of your home-selling journey? Visit our Process page to see how we turn a complex process into a quick and easy solution. Your dream sale is just a click away—learn more and get started today.`,
    ],
    mainTitle: 'Cash for Houses, Quickly',
    reverse: true,
    hasAnimation:true,
